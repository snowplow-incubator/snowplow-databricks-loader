...
class KinesisConfigSpec extends Specification with CatsEffect {
  ...
  private def minimal = {
    ...
    ConfigParser.configFromFile[IO, Config[KinesisFactoryConfig, KinesisSourceConfig, KinesisSinkConfig]](path).value.map { result =>
...
object KinesisConfigSpec {
  private val expectedMinimalConfig = Config[KinesisFactoryConfig, KinesisSourceConfig, KinesisSinkConfig](
  ...
  private val expectedExtendedConfig = Config[KinesisFactoryConfig, KinesisSourceConfig, KinesisSinkConfig](
    input = KinesisSourceConfig(
      appName                          = "snowplow-databricks-loader",
      streamName                       = "snowplow-enriched-events",
      workerIdentifier                 = "test-hostname",
