...
val sqlPath = "/Shared/snowplow-dlt-demo.sql"
/****/
...
TBLPROPERTIES ('delta.dataSkippingNumIndexedCols' = '4')
AS
SELECT
  ...
  derived_tstamp,
  dvce_created_tstamp,
  * except (collector_tstamp, derived_tstamp, dvce_created_tstamp),
...
val createPipelineRequest = new CreatePipeline()
  .setName(s"snowplow-load-to-$table")
  ...
  .setServerless(false)  // TODO: what are the implications?
